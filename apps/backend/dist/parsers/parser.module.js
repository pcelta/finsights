...
const anz_parser_1 = require("./anz.parser");
...
exports.ParserModule = ParserModule = __decorate([
    (0, common_1.Module)({
        providers: [anz_parser_1.ANZParser, transaction_parser_service_1.TransactionParserService],
        exports: [transaction_parser_service_1.TransactionParserService],
    })
], ParserModule);
